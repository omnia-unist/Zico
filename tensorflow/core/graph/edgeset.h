...
//  ///////////////////////////////////////////////////////////////////////////
//  // gangmuk: creating one another value_type 
//  // which is non-const to use in CategorizeEdges(Node *n) in executor.cc
//  typedef Edge* non_const_key_type;
//  typedef Edge* non_const_value_type;
//  // gangmuk:
//  class non_const_iterator;
//  typedef non_const_iterator non_const_iterator; // meaningless line
//  // gangmuk: 
