...
class MklSmallSizeAllocator : public Allocator {
 public:
  ...
  void* AllocateRaw(size_t alignment, size_t num_bytes) override {
    ...
    printf("MklSmallSizeAllocator::AllocateRaw\n");
    return ptr;
  }
  ...
  void DeallocateRaw(void* ptr) override {
    ...
    printf("MklSmallSizeAllocator::DeallocateRaw\n");
  }
...
class MklCPUAllocator : public Allocator {
 public:
  ...
  Status Initialize() {
    ...
    std::cout << "MklCPUAllocator: in MklCPUAllocator" << std::endl;
    ...
    // Gangmuk
    // large_size_allocator_ = new OriginalBFCAllocator(
    //     sub_allocator_, max_mem_bytes, kAllowGrowth, kName);
    // printf("MklCPUAllocator OriginalBFCAllocator\n");
