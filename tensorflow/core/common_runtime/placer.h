...
class Placer {
 public:
  ...
  int gangmuk_job_id;
  std::set<std::string> existing_devices;
  int cpu_id = -1;
 ...
 private:
  ...
  // Gangmuk
  // void AssignAndLog(int assigned_device, string assigned_device_name,
  ...
  // Gangmuk
  void ReAssignAndLog(int assigned_device, string assigned_device_name,
                    Node* node, int pass) const;
