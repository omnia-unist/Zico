...
class DeviceBase {
 public:
  ...
  /***********************************************************************/
  virtual size_t NumUsedEvents() const { return 88888888; }
  virtual size_t NumPendingEvents() const { return 99999999; }
  // virtual bool SkipAllTest() const { return false; }
  // virtual bool SkipRefCountIsOne() const { return false; }
  virtual int RecordOutputTensorOnly() const { return 0; }
  // virtual bool TensorRecordingOriginalVersion() const { return true; }
  // virtual bool ThrottleKernelLaunch() const { return false; }
  virtual int MaxLaunchedKernels() const { return 0; }
  virtual int ForwardInputProfilingMode() const { return 0; }
  virtual int PrintForwardInputOrAllocateOutput() const { return 0; }
  virtual int PrintCoordinator() const { return 0; }
  virtual std::string CoordinatorPolicy() const { return "not_init"; }
  virtual int PrintRawInternalCsv() const { return 0; }

  virtual int InplaceProfilingStep() const { return 0; }
  virtual int BFCPhaseTwoStep() const { return 0; }
  virtual int AllocationInfoRegistrationStep() const { return 0; }
  virtual int PrintSummaryStep() const { return 0; }
  virtual int StartAligningStep() const { return 0; }
  virtual int NumVirtualGPU() const { return 0; }
  virtual bool TurnOnCoordinator() const { return false; }
  virtual int ForceNoInplace() const { return 0; }
  virtual int PrintForwardInput() const { return 0; }
