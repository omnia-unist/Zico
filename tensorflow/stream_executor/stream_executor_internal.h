...
class StreamExecutorInterface {
 public:
  ...
  virtual void *UnifiedMemoryAllocate(uint64 size) { return nullptr; }
	// Gangmuk
  virtual void *UnifiedMemoryAllocate(uint64 size, std::mutex mtx_allocate) { return nullptr; }

  // Deallocates unified memory space previously allocated with
  // UnifiedMemoryAllocate.
  virtual void UnifiedMemoryDeallocate(void *mem) {}
	// Gangmuk
  virtual void UnifiedMemoryDeallocate(void *mem, std::mutex mtx_deallocate) {}
